// Based on https://raw.githubusercontent.com/techniboogie-dart/recase/master/test/recase_test.dart
...
void main() {
  StringHelper rcInput = new StringHelper('This is-Some_sampleText. YouDig?');
  StringHelper allCapsInput = new StringHelper('FOO_BAR');
