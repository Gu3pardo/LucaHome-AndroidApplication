...
final nextCloudCredentialsReducer = combineReducers<NextCloudCredentials>([
  new TypedReducer<NextCloudCredentials, NextCloudCredentialsLogIn>(_logIn),
...
NextCloudCredentials _logIn(NextCloudCredentials nextCloudCredentials, action) => nextCloudCredentials;
