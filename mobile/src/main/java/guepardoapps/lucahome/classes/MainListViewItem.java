...
public class MainListViewItem {
    public enum Type {Birthday, Coin, MediaServer, Menu, Meter, MoneyMeter, Movie, Schedule, Security, Settings, Shopping, Timer, Weather, WirelessSocket, WirelessSwitch}
