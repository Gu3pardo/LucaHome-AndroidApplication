            ...
            public void onClick(View view) {
                ...
                if (cancel) {
                    ...
                    if (_coinDto.GetAction() == CoinDto.Action.Add) {
                        _coinService.AddCoin(new Coin(-1, userName, coinType, Double.parseDouble(coinAmountString), -1));
                        _saveButton.setEnabled(false);
                    } else if (_coinDto.GetAction() == CoinDto.Action.Update) {
                        _coinService.UpdateCoin(new Coin(_coinDto.GetId(), userName, coinType, Double.parseDouble(coinAmountString), -1));
                        _saveButton.setEnabled(false);
                    } else {
