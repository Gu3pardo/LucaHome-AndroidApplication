...
public class DatabaseWirelessScheduleList implements IDatabaseLucaClassList<WirelessSchedule> {
    ...
    private static final String DatabaseTable = "DatabaseWirelessScheduleListTable";
    ...
    public DatabaseWirelessScheduleList(@NonNull Context context) {
        _context = context;
    }

    @Override
    public DatabaseWirelessScheduleList Open() throws SQLException {
    ...
    @Override
    public long AddEntry(@NonNull WirelessSchedule entry) {
    ...
    @Override
    public long UpdateEntry(@NonNull WirelessSchedule entry) throws SQLException {
        ContentValues contentValues = new ContentValues();
    ...
    @Override
    public long DeleteEntry(@NonNull WirelessSchedule entry) throws SQLException {
    ...
    @Override
    public ArrayList<WirelessSchedule> GetList(String selection, String groupBy, String orderBy) throws SQLException {
        ...
        ArrayList<WirelessSchedule> result = new ArrayList<>();
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            WirelessSchedule entry = new WirelessSchedule(uuid, name, dateTime, isActive, wirelessSocketUuid, wirelessSocketAction, wirelessSwitchUuid, isOnServer, serverDbAction);
            result.add(entry);
        }
