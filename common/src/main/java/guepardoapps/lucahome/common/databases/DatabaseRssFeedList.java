...
public class DatabaseRssFeedList implements IDatabaseLucaClassList<RssFeed> {
    ...
    public DatabaseRssFeedList(@NonNull Context context) {
        _context = context;
    }

    @Override
    public DatabaseRssFeedList Open() throws SQLException {
    ...
    @Override
    public long AddEntry(@NonNull RssFeed entry) {
    ...
    @Override
    public long UpdateEntry(@NonNull RssFeed entry) throws SQLException {
        ContentValues contentValues = new ContentValues();
    ...
    @Override
    public long DeleteEntry(@NonNull RssFeed entry) throws SQLException {
    ...
    @Override
    public ArrayList<RssFeed> GetList(String selection, String groupBy, String orderBy) throws SQLException {
        ...
        ArrayList<RssFeed> result = new ArrayList<>();
