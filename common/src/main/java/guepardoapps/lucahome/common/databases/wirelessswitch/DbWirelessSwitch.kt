...
class DbWirelessSwitch(context: Context, factory: SQLiteDatabase.CursorFactory?)
    ...
    fun getList(): MutableList<WirelessSwitch> {
    ...
    fun add(entity: WirelessSwitch): Long {
        val values = ContentValues().apply {
    ...
    fun update(entity: WirelessSwitch): Int {
        val values = ContentValues().apply {
            put(ColumnUuid, entity.uuid.toString())
            put(ColumnRoomUuid, entity.roomUuid.toString())
            put(ColumnName, entity.name)
    ...
    fun delete(entity: WirelessSwitch): Int {
        val database = this.writableDatabase
