...
public enum YoutubeIdType implements Serializable {
    ...
    BIRTHDAY_SONG(35, "Happy Birthday", "inS9gAgSENE"),

    SEA_SOUND(36, "Relaxing sea sound", "olDp7ufxjyM"),

    RELAXING_PIANO_MIX(37, "Relaxing piano mix", "Ne5J4bxWypI"),
    RELAXING_GUITAR_MIX(38, "Relaxing guitar mix", "ss7EJ-PW2Uk"),

    EDM_PARTY_CLUB_DANCE_MIX_24_7(39, "EDM Party Club Dance Mix 24/7", "v=ZHJZFEbFpIE"),
    BEST_PARTY_CLUB_DANCE_MIX_24_7_M4U(40, "Best Party Club Dance Mix 24/7 M4U", "v=jqkeHzIeo74"),
    CLUB_DANCE_MIX(41, "Club Dance Mix", "v=5XRpRtoxzFQ");

    private int _id;
    private String _title;
    private String _youtubeId;

    YoutubeIdType(int id, String title, String youtubeId) {
        _id = id;
        _title = title;
    ...
    public static YoutubeIdType GetById(int id) {
        for (YoutubeIdType e : values()) {
            if (e._id == id) {
                return e;
            }
        }
    ...
    public static YoutubeIdType GetByTitle(String title) {
        for (YoutubeIdType e : values()) {
    ...
    public static YoutubeIdType GetByYoutubeId(String youtubeId) {
        for (YoutubeIdType e : values()) {
            if (e._youtubeId.contains(youtubeId)) {
                return e;
            }
        }
        return DEFAULT;
