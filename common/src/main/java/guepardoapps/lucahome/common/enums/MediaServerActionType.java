...
public enum MediaServerActionType implements Serializable {
    ...
    GET_INFORMATION_DATA(100, "GET_INFORMATION_DATA", 1),
    GET_NOTIFICATION_DATA(101, "GET_NOTIFICATION_DATA", 1),
    GET_RADIO_STREAM_DATA(102, "GET_RADIO_STREAM_DATA", 1),
    GET_SLEEP_TIMER_DATA(103, "GET_SLEEP_TIMER_DATA", 1),
    ...
    MediaServerActionType(int id, String action, int actionLevel) {
        _id = id;
        _action = action;
    ...
    public static MediaServerActionType GetById(int id) {
        for (MediaServerActionType e : values()) {
            if (e._id == id) {
                return e;
            }
        }
    ...
    public static MediaServerActionType GetByString(String action) {
        for (MediaServerActionType e : values()) {
