...
public class ScheduleView extends Activity {
    ...
    private SerializableList<ScheduleDto> _itemList = new SerializableList<>();
    ...
    private BroadcastReceiver _updateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            SerializableList<ScheduleDto> itemList = (SerializableList<ScheduleDto>) intent
            ...
            if (itemList != null) {
                ...
                if (_itemList.getSize() == 0) {
                    ...
                    _listAdapter = new ScheduleListAdapter(_context, _itemList, null, true, PhoneMessageService.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _itemList.addValue(new ScheduleDto(R.xml.circle_yellow, "Loading...", "", false));
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                if (!_isInitialized) {
                    _receiverController.RegisterReceiver(_updateReceiver,
                            new String[]{Broadcasts.UPDATE_SCHEDULE_LIST});
