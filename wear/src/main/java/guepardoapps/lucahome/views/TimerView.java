...
public class TimerView extends Activity {
    ...
    private static final String COMMAND = "ACTION:GET:TIMER";
    ...
    private SerializableList<TimerDto> _itemList = new SerializableList<>();
    ...
    private BroadcastReceiver _updateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            SerializableList<TimerDto> itemList = (SerializableList<TimerDto>) intent
            ...
            if (itemList != null) {
                ...
                if (_itemList.getSize() == 0) {
                    ...
                    _listAdapter = new TimerListAdapter(_context, _itemList, null, true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _itemList.addValue(new TimerDto(R.xml.circle_yellow, "Loading...", "", false));
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                ...
                if (!_isInitialized) {
                    _receiverController.RegisterReceiver(_updateReceiver,
                            new String[]{Broadcasts.UPDATE_TIMER_LIST});
