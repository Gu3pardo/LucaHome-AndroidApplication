...
public class Bundles {
    ...
    public static final String CURRENT_RECEIVED_BRIGHTNESS = "CURRENT_RECEIVED_BRIGHTNESS";
    ...
    public static final String MEDIAMIRROR_COMMAND = "MEDIA_MIRROR_COMMAND";
    public static final String MEDIAMIRROR_VIEW_DTO = "MEDIA_MIRROR_VIEW_DTO";
    public static final String MEDIAMIRROR = "MEDIA_MIRROR";
    ...
    public static final String MOTION_CAMERA_DTO_DOWNLOAD = "MOTION_CAMERA_DTO_DOWNLOAD";
    ...
    public static final String TEMPERATURE_SINGLE = "TEMPERATURE_SINGLE";
    ...
    public static final String WEAR_MESSAGE_TEXT = "WEAR_MESSAGE_TEXT";
