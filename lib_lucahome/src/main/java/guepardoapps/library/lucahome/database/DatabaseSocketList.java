...
public class DatabaseSocketList {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase database) {
            database.execSQL(" CREATE TABLE " + DATABASE_TABLE + " ( " + KEY_ROW_ID + " TEXT NOT NULL, " + KEY_NAME
                    + " TEXT NOT NULL, " + KEY_AREA + " TEXT NOT NULL, " + KEY_CODE + " TEXT NOT NULL, "
    ...
    public DatabaseSocketList(Context context) {
    ...
    public long CreateEntry(WirelessSocketDto newEntry) {
    ...
    public SerializableList<WirelessSocketDto> GetSocketList() {
        ...
        SerializableList<WirelessSocketDto> result = new SerializableList<>();
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            WirelessSocketDto entry = new WirelessSocketDto(id, name, area, code, isActivated);
    ...
    public void Delete(WirelessSocketDto deleteEntry) throws SQLException {
