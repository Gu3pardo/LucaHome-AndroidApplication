...
public class DatabaseTimerList {

    private static final String TAG = DatabaseTimerList.class.getSimpleName();
    ...
    private static final String DATABASE_NAME = "DatabaseTimerListDb";
    private static final String DATABASE_TABLE = "DatabaseTimerListTable";
    ...
    public DatabaseTimerList(Context context) {
        _logger = new LucaHomeLogger(TAG);
        _context = context;
    }

    public DatabaseTimerList Open() throws SQLException {
    ...
    public long CreateEntry(@NonNull TimerDto newEntry) {
    ...
    public SerializableList<TimerDto> GetTimerList(@NonNull SerializableList<WirelessSocketDto> socketList) {
        ...
        SerializableList<TimerDto> result = new SerializableList<>();
    ...
    public void Delete(TimerDto deleteEntry) throws SQLException {
