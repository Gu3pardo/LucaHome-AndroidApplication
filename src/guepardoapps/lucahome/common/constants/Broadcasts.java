...
public class Broadcasts {
	...
	// Sound View
	public static final String UPDATE_SONG_VIEW = "guepardoapps.lucahome.broadcast.update.view.song.details";
	public static final String IS_SOUND_PLAYING = "guepardoapps.lucahome.broadcast.get.isplaying";
	public static final String PLAYING_FILE = "guepardoapps.lucahome.broadcast.get.playingfile";
	public static final String GET_SOUNDS = "guepardoapps.lucahome.broadcast.get.sounds";
	public static final String GET_VOLUME = "guepardoapps.lucahome.broadcast.get.volume";
	public static final String START_SOUND = "guepardoapps.lucahome.broadcast.start.sound";
	public static final String STOP_SOUND = "guepardoapps.lucahome.broadcast.stop.sound";
	public static final String SET_RASPBERRY = "guepardoapps.lucahome.broadcast.set.raspberry";
	public static final String ACTIVATE_SOUND_SOCKET = "guepardoapps.lucahome.broadcast.activate.sound.socket";
	public static final String DEACTIVATE_SOUND_SOCKET = "guepardoapps.lucahome.broadcast.deactivate.sound.socket";
